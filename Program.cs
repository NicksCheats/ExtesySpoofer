...
namespace HWIDSpoofer // Program was written and tested by SheLuvNick#0013
{
    class Program
    { 
        public static string textLogo = @"   ____  ____  ____      ____  _____  ______      ______   _______     ___      ___   ________  ________  _______    " + Environment.NewLine +
            ...
            @"    |  __  |     \ \/  \/ /     | |    | |  | |  _.____`.   |  ___/ | |   | || |   | | |  _|     |  _| _   |  __ /   " + Environment.NewLine + // This whole section was made by luffyz
        ...
        static void Main(string[] args) // https://discord.gg/3xfdTTC67b
        {
        begin:
            Console.Title = "ExtesyHWID Spoofer by SheLuvNick#0013";
            Console.ResetColor();
            Console.Clear();
